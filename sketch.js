...
function preload(){
  ...
  cloudImage = loadImage("download-2.jpg");
  
  obstacle1 = loadImage("images.jpg");
  obstacle2 = loadImage("images.jpg");
  obstacle3 = loadImage("s.jpg");
  obstacle4 = loadImage("s.jpg");
  obstacle5 = loadImage("images-1.jpg");
  obstacle6 = loadImage("images-1.jpg");
